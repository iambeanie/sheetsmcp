...
oauth_config_dir="$config_home/sheetsmcp"
oauth_config_path="$oauth_config_dir/oauth_client.json"
oauth_token_dir="$data_home/sheetsmcp/google-oauth"
...
configure_claude() {
    local claude_config="$config_home/Claude/claude_desktop_config.json"
...
main() {
    info "$app_name Linux x64 installer"
    install_binary
